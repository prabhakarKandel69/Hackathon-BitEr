...
# Function to extract work experience keywords using TF-IDF
def extract_work_experience_keywords(input_file, output_file):
    ...
    with open(output_file, 'w') as f:
        f.write("Important Work Experience Keywords:\n")
...
extract_work_experience_keywords(input_work_experience_tokenized_file, output_work_experience_keywords_file)
